...
export const C40FairTestLab = ({ state, onStateChange }: Props) => {
    ...
    const drawScene = ({ ctx, safeRight, raw }: LabScene) => {
        ...
        VARIABLES.forEach((name, i) => {
            ...
            outlineText(ctx, isChanged ? 'CHANGED' : 'the same', safeRight - 130, y + 19, 'bold 13px monospace',
        ...
        return { meter: { fraction: confidence, caption: 'Can You Name the Cause?', low: 'No idea', high: 'Fair test' }, note: msg };
    };
