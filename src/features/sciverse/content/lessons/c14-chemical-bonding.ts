...
export const getC14Script = (): Record<string, DialogNode> => ({
    ...
    'water_hint': {
        id: 'water_hint',
        speaker: 'AI',
        content: "Oxygen is **electronegative** -- it pulls shared electrons strongly -- but it does not take them completely from hydrogen; it just pulls them closer. This is a *polar covalent* bond: the shared electrons spend more time near oxygen than hydrogen. 🌊\n\nCompare that with **nonpolar covalent** bonds (like H-H), where electrons are shared more equally.",
        options: [
