...
export function getL2P9Script(): Record<string, DialogNode> {
    return {
        ...
        checkpoint_correct: {
            ...
            speaker: 'AI',
            content: "Correct. **The change tells you how much was added; the percentage change tells you what share of the starting size was added. They can disagree.**\n\nFor living things, the percentage is often the more natural measure. A plant grows by making new cells, and a bigger plant has more cells making them -- so a bigger plant can add more centimetres.\n\nIf every week added the **same share**, the plant would add more centimetres every single week, faster and faster, for ever. The sunflower did not. Its share fell week by week -- **140%** in week 4, **68%** in week 6, **31%** in week 7 -- which is why its centimetres were biggest in the middle and then slowed. **Why the share falls** is a question for Level 3.\n\nC9 said growth needs raw materials. C9 at Level 2 finds out how much of them a bag of plant food really holds.",
