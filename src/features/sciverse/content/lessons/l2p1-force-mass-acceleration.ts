 ...
 * force and a = F/m, which puts one quantity in the numerator and another in
 * the denominator -- the same "where does the number sit" reading that L2P49
 * makes explicit. The two terms are introduced here, since this is the first
 * Level 2 lesson in the running order.
 */
