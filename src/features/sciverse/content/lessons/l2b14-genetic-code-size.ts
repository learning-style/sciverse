...
export function getL2B14Script(): Record<string, DialogNode> {
    return {
        root: {
            id: 'root',
            speaker: 'AI',
            content: "B14 found that **DNA** -- **deoxyribonucleic acid** -- spells its instructions with four letters -- **A, T, G, C** -- and that the words, called **codons**, are exactly **three** letters long. Each word names one of the **20 amino acids** that proteins are built from, or says **stop**.\n\nThree letters is a strange number to land on. Why not one letter for each amino acid, or two?\n\nWhat do you think forced the word length to be three?",
