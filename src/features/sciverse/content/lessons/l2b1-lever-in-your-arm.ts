...
export function getL2B1Script(): Record<string, DialogNode> {
    return {
        ...
        checkpoint: {
            ...
            options: [
                { id: 'right', label: "The bag's distance from the pivot. Distance is in the numerator, so holding it further out multiplies the moment and the muscle force with it.", nextNodeId: 'checkpoint_correct', sentiment: 'positive' },
