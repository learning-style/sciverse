...
export function getB46Script(): Record<string, DialogNode> {
    return {
        ...
        misconception: {
            id: 'misconception',
            speaker: 'AI',
            content: "The colour is still arriving! Point a camera at that dim room, leave the shutter open, and the photograph comes out in full colour. The light entering your eye still carries it.\n\nThe limit is in **you**. The back of your eye, the **retina**, holds two different kinds of detector cell:\n\n- **Cones** detect **colour**, but they need a decent amount of light to fire\n- **Rods** are far more sensitive and work in very dim light, but they cannot tell colours apart at all\n\nIn daylight your cones do the work and you see colour. As the light drops, cones stop firing and rods take over. Rods report brightness only -- so you get a detailed grey picture.\n\nYou are not losing the colour. You are switching to a different set of cells.",
            options: [
        ...
        correct: {
            id: 'correct',
            speaker: 'AI',
            content: "Exactly! And here is where **P46** gets its answer.\n\nYou have **three kinds of cone**, and each responds best to a different part of the light:\n\n1. Cones most sensitive to **red** light\n2. Cones most sensitive to **green** light\n3. Cones most sensitive to **blue** light\n\nThat is it. Three. Every colour you have ever seen is your brain comparing how strongly those three types are firing. Yellow light does not have its own cone -- it simply fires the red and green cones roughly equally, and your brain calls that yellow.\n\nWhich is exactly why a screen only needs **red**, **green** and **blue** dots. A screen is not reproducing real yellow light. It is firing your red and green cones in the same ratio that real yellow would, and your brain cannot tell the difference.\n\n**Screens are built with three colours because your eye is.**\n\nIn the picture, the **cone cells** and **rod cells** respond as the light changes.\n\nSlide **Light Level** and watch the colour drain away!",
